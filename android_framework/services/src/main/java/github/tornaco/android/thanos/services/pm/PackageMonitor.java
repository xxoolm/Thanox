...
public abstract class PackageMonitor extends android.content.BroadcastReceiver {
    ...
    public void onBeginPackageChanges() {
        Timber.d("onBeginPackageChanges");
    }
    ...
    public void onPackageAdded(String packageName, int uid) {
        Timber.d("onPackageAdded: %s", packageName);
    }
    ...
    public void onPackageRemoved(String packageName, int uid) {
        Timber.d("onPackageRemoved: %s", packageName);
    }
    ...
    public void onPackageRemovedAllUsers(String packageName, int uid) {
        Timber.d("onPackageRemovedAllUsers: %s", packageName);
    }

    public void onPackageUpdateStarted(String packageName, int uid) {
        Timber.d("onPackageUpdateStarted: %s", packageName);
    }

    public void onPackageUpdateFinished(String packageName, int uid) {
        Timber.d("onPackageUpdateFinished: %s", packageName);
    }
    ...
    public boolean onPackageChanged(String packageName, int uid, String[] components) {
        Timber.d("onPackageChanged: %s", packageName);
        if (components != null) {
    ...
    public boolean onHandleForceStop(Intent intent, String[] packages, int uid, boolean doit) {
        Timber.d("onHandleForceStop: %s", intent);
        return false;
    }

    public void onHandleUserStop(Intent intent, int userHandle) {
        Timber.d("onHandleUserStop: %s", intent);
    }

    public void onUidRemoved(int uid) {
        Timber.d("onUidRemoved: %s", uid);
    }

    public void onPackagesAvailable(String[] packages) {
        Timber.d("onPackagesAvailable: %s", Arrays.toString(packages));
    }

    public void onPackagesUnavailable(String[] packages) {
        Timber.d("onPackagesUnavailable: %s", Arrays.toString(packages));
    }

    public void onPackagesSuspended(String[] packages) {
        Timber.d("onPackagesSuspended: %s", Arrays.toString(packages));
    }

    public void onPackagesSuspended(String[] packages, Bundle launcherExtras) {
        onPackagesSuspended(packages);
        Timber.d("onPackagesSuspended2: %s %s", Arrays.toString(packages), launcherExtras);
    }

    public void onPackagesUnsuspended(String[] packages) {
        Timber.d("onPackagesUnsuspended: %s", Arrays.toString(packages));
    }
    ...
    public void onPackageDisappeared(String packageName, int reason) {
        Timber.d("onPackageDisappeared: %s", packageName);
    }
    ...
    public void onPackageAppeared(String packageName, int reason) {
        Timber.d("onPackageAppeared: %s", packageName);
    }
    ...
    public void onPackageModified(String packageName) {
        Timber.d("onPackageModified: %s", packageName);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (mChangeUserId == UserHandle.USER_NULL) {
            Timber.w("Intent broadcast does not contain user handle: " + intent);
            return;
        }
        ...
        if (Intent.ACTION_PACKAGE_ADDED.equals(action)) {
            ...
            String[] pkgList = intent.getStringArrayExtra(Intent.EXTRA_CHANGED_PACKAGE_LIST);
            final Bundle launcherExtras = intent.getBundleExtra(EXTRA_LAUNCHER_EXTRAS);
            mSomePackagesChanged = true;
