 ...
 */
public abstract class ShellCommandCompat {

    static final String TAG = "ShellCommandCompat";
     ...
     * are executing.  The easiest way to do this is to have the ShellCommandCompat contain
     ...
     */
    public abstract int onCommand(String cmd) throws RemoteException;
