 ...
 * loading the global an XML file on construction.
 * <p>
...
final class SettingsState {
    ...
    SettingsState(Object lock, File file, int key,
    ...
    // The settings provider must hold its lock when calling here.
    boolean insertSettingLocked(String name, String value, String tag,
    ...
    private static void writeSingleSetting(int version, XmlSerializer serializer, String id,
    ...
    private static void setValueAttribute(String attr, String attrBase64, int version,
    ...
    private class HistoricalOperation {
        ...
        HistoricalOperation(long timestamp,
    ...
    class Setting {
        ...
        boolean update(String value, boolean setDefault, String packageName, String tag,
            ...
            if (setDefault) {
                if (!ObjectsUtils.equals(value, this.defaultValue)
            ...
            if (ObjectsUtils.equals(value, this.value)
                    && ObjectsUtils.equals(defaultValue, this.defaultValue)
                    && ObjectsUtils.equals(packageName, this.packageName)
                    && ObjectsUtils.equals(tag, this.tag)
    ...
    /**
     * @return TRUE if a string is considered "binary" global KXML's point of view.  NOTE DO NOT
     * pass null.
     */
